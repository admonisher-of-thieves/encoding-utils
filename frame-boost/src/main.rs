...
struct Args {
    ...
    #[arg(
        long,
        default_value = "--verbose --workers 4 --concat mkvmerge --chunk-method bestsource --encoder svt-av1 --split-method av-scenechange --sc-method standard --extra-split 240 --min-scene-len 24"
    )]
    av1an_params: String,
